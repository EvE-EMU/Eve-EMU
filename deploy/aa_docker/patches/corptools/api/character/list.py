...
from corptools_audit_issues import character_list_entry
            ...
            for char in characters:
                ...
                for c in char.character_ownership.user.character_ownerships.all():
                    ...
                    output[main.character_id]["characters"].append(
                        character_list_entry(c.character)
                    )
                ...
                for char in orphans:
                    try:
                        ...
                        if main.character_id not in output:
                            output[main.character_id] = {
                                "main": main,
                                "characters": [character_list_entry(main)]
                            }
                        output[main.character_id]["characters"].append(
                            character_list_entry(char.character)
                        )
                    except Exception:
                        main = char.character
                        output[main.character_id] = {
                            "main": main,
                            "orphan": True,
                            "characters": [character_list_entry(char.character)]
                        }
