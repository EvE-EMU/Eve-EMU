...
class MarketManager(commands.Cog):
    ...
    async def update_publicmarketdata_ores(
        ...
        for item_type in ItemType.objects.filter(group__eve_category_id=ASTEROID, market_group__isnull=False, published=1):
    ...
    async def optimize(
        ...
        for mineral in required_minerals:
            ...
            for _mineral_refine_cache in ItemTypeMaterial.objects.filter(
                    item_type__group__eve_category_id=ASTEROID,
                    item_type__market_group__isnull=False, item_type__published=1,
        ...
        for order in Order.objects.filter(
                item_type__group__eve_category_id=ASTEROID,
                item_type__market_group__isnull=False, item_type__published=1, is_buy_order=0,
