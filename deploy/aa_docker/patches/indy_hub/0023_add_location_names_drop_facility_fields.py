# Patched for PostgreSQL: skip ADD COLUMN when column already exists (eve-emu Docker).
...
def add_blueprint_location_column(apps, schema_editor):
    if schema_editor.connection.vendor == "mysql":
        ...
        return
    if _column_exists(schema_editor, "indy_hub_indyblueprint", "location_name"):
        return
...
def add_industryjob_location_column(apps, schema_editor):
    if schema_editor.connection.vendor == "mysql":
        ...
        return
    if _column_exists(schema_editor, "indy_hub_industryjob", "location_name"):
        return
...
def add_industryjob_facility_column(apps, schema_editor):
    if schema_editor.connection.vendor == "mysql":
        ...
        return
    if _column_exists(schema_editor, "indy_hub_industryjob", "facility_id"):
        return
...
def add_industryjob_blueprint_location_column(apps, schema_editor):
    if schema_editor.connection.vendor == "mysql":
        ...
        return
    if _column_exists(schema_editor, "indy_hub_industryjob", "blueprint_location_id"):
        return
...
def add_industryjob_output_location_column(apps, schema_editor):
    if schema_editor.connection.vendor == "mysql":
        ...
        return
    if _column_exists(schema_editor, "indy_hub_industryjob", "output_location_id"):
        return
